...
public class BacklogController {
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id){
        ProjectTask projectTask = projectTaskService.findTaskBySequence(backlog_id, pt_id);
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask,BindingResult result, @PathVariable String backlog_id, @PathVariable String pt_id){
        ...
        ProjectTask updateProjectTask = projectTaskService.updateByProjectID(projectTask, backlog_id, pt_id);
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id){
        ...
        projectTaskService.deleteProjectTaskById(backlog_id, pt_id);
